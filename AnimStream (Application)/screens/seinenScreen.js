...
class SeinenScreen extends React.Component {
	constructor(props) {
        super(props);
        this.state = {
			anime:[]
		...
		return (
			<ScrollView style={styles.background}>
				{this.state.anime.map(anim => {
					if (anim.category === 'Seinen') {
						return (
							<TouchableOpacity 
							 onPress={() => this.props.navigation.navigate('Video')} style={styles.row}>
								<Image
									style={styles.image}
...
SeinenScreen.navigationOptions = {
	title: 'Seinen',
